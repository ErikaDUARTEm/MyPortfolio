...
const projects = [
          ...
          "description":"Down Family es una red social dirigida a padres o familias con hijos que tienen Síndrome de Down. El objetivo es interactuar y compartir información sobre temas relacionados con el Síndrome de Down.",
    ...
    const card = `
      <article class="card-projects">
        <article class="allprojects">
            ...
            <figcaption class="allText-card">${data.name}</figcaption> 
          </figure>
          ...
          <button type="button" class="button-card">Repositorio</button>
          <button type="button" class="button-card">Demo</button>
          </div>
      </article>
  `
  return card;
